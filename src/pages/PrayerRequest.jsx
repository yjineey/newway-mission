...
요르단 선교팀이 문화와 언어의 장벽을 넘어, 요르단 영혼들에게 복음을 자연스럽고 안전하게 전할 수 있는 길이 열리도록.`,
  ...
  // 요르단 선교팀을 위한 중보 내용 (별도 카테고리는 아니지만 내용 추가)
  const prayerTeamContent = `요르단 선교팀이 어떠한 사역과 준비에 앞서, 무엇보다 요르단을 향하신 하나님의 마음과 얼굴을 구하는 것을 가장 우선순위에 두고 준비할 수 있도록. 하나님이 이 간구를 들으시고, 하나님의 마음과 뜻을 우리 팀에게 계시하여 주시기를.
