...
import ChurchInfoTabs from '../components/common/ChurchInfoTabs';
...
function ChurchInfo() {
  ...
  return (
    <PageLayout title="교회 소개">
      <ChurchInfoTabs selectedTab={selectedTab} onTabChange={setSelectedTab} />
      ...
      <div className="space-y-6">
        ...
        {selectedTab === 'greeting' && (
          <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <p>
              성경은 마지막 때를 향하여 갈수록 사랑이 식어져 갈 것이라고
              이야기 하고 있습니다. 하지만, 이 땅을 살아가는 우리에게 주신
              가장 큰 계명은 우리의 마음을 다하고 뜻을 다하고 힘을 다하여 우리
              하나님을 사랑하고 내 이웃을 내 몸과 같이 사랑하는 것입니다.
            </p>
            <p>
              뉴웨이교회는 주님이 원하시는 때에, 주님이 원하시는 것을 드리며
              주님의 마음을 시원케 해드리는 교회로 일어나기를 소망합니다.
              능력의 많고 적음에서 비롯된 것이 아닌, 하나님을 전심으로
              사랑하는 그 마음이 우리의 원동력이 될 것입니다.
            </p>
            ...
            <p>
              기쁨과 즐거움으로 예수 그리스도를 따르는 무리가 아닌 제자된
              교회로 일어나기를 소망합니다. 이 시대와 세대를 향하신 하나님의
              꿈이 이루어지고 완성되어지기까지, 우리는 이 걸음을 멈추지 않을
              것입니다.
            </p>
          </div>
        )}
        ...
        {selectedTab === 'values' && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* LOVING GOD */}
            <div className="p-6 bg-white dark:bg-[#252525] rounded-xl border border-gray-200 dark:border-[#333333]">
              ...
              <div className="border-t border-gray-200 dark:border-[#333333] pt-4">
                <p className="text-xs text-gray-600 dark:text-gray-400 leading-relaxed">
                  ...
                  평생에 여호와의 집에 살면서 여호와의 아름다움을 바라보며
