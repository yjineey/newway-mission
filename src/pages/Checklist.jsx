...
function Checklist() {
  ...
  const renderContent = () => {
    if (selectedTab === 'departure') {
      return (
        <div
          className="bg-white dark:bg-[#252525] rounded-2xl shadow-soft border border-gray-200 dark:border-[#333333] p-6 md:p-8 overflow-x-auto"
          style={{ wordBreak: 'keep-all' }}
        >
          <h2 className="text-base font-bold text-gray-900 dark:text-white mb-4 whitespace-nowrap">
            출발 전 준비사항
          </h2>
          ...
          <div className="space-y-4">
            {/* 5) 팀 준비사항 */}
            <div
              className="flex items-start gap-3 p-4 bg-gray-50 dark:bg-[#2d2d2d] rounded-xl overflow-x-auto"
              style={{ wordBreak: 'keep-all' }}
            >
            ...
            >
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-gray-700 dark:text-gray-300 space-y-2">
                  <p className="whitespace-nowrap">
                    1. 항공권 구매 시, 수화물 허용 무게에 대해 확인해주세요
                  </p>
            ...
            >
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-gray-700 dark:text-gray-300 space-y-2">
                  ...
                  <p className="pl-4 text-xs whitespace-nowrap">
