  ...
  const teamData = {
    egypt: [
      ...
      },
      {
        ...
        sub: '',
        detail:
          '철저히 시간을 관리\n- 훈련기간: 공지된 모임 시간 지속 알림, 모임시간 10분 전까지 모든 팀원이 준비를 마치고 대기 할 수 있도록 함\n- 선교기간: 훈련기간과 동일, 선교사님들이 기다리는 일 없도록 철저히 관리',
      },
      {
        role: '라스트키퍼',
        main: '',
